    ...
    <footer className="bg-foreground text-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-12">
          {/* Company Info */}
          <div>
            <img src={logo} alt="Asegedech Adane Coffee" className="h-12 w-auto mb-6 brightness-0 invert" />
            <p className="text-gray-300 text-sm leading-relaxed mb-4">
              Premium Ethiopian green coffee beans, ethically sourced from the highlands of Guji.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li><Link to="/products" className="text-gray-300 hover:text-primary transition-colors">Single Origin</Link></li>
              <li><Link to="/products" className="text-gray-300 hover:text-primary transition-colors">Bulk Orders</Link></li>
              <li><Link to="/products" className="text-gray-300 hover:text-primary transition-colors">Specialty Beans</Link></li>
              <li><Link to="/products" className="text-gray-300 hover:text-primary transition-colors">Organic Coffee</Link></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-4">
              <li className="flex items-start gap-3">
                ...
                <span className="text-gray-300 text-sm">Guji, Ethiopia</span>
              </li>
              <li className="flex items-start gap-3">
                <Phone className="w-5 h-5 text-primary mt-1 flex-shrink-0" />
                <a href="tel:+251979206192" className="text-gray-300 text-sm hover:text-primary transition-colors">
                  +251 979 206 192
                </a>
              </li>
              <li className="flex items-start gap-3">
